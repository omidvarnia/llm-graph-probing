...
class PerplexityRevised(evaluate.Metric):
    def _info(self):
    ...
    def _compute(
        self, predictions, model_id, revision: str="main", batch_size: int = 16, add_start_token: bool = True, device=None, max_length=None, position=None
    ):
        ...
        for start_index in logging.tqdm(range(0, len(encoded_texts), batch_size), position=position):
